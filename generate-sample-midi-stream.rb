require_relative 'DigitalSynthVRA8M/common'
...
control_change(VCA_GAIN         , 127)
control_change(EG_ATTACK        , 104)
control_change(EG_DECAY_RELEASE , 104)
control_change(EG_SUSTAIN       , 96 )
play_cegbdfac(4)
...
control_change(VCO_PORTAMENTO   , 64 )
control_change(VCF_CUTOFF       , 0  )
control_change(VCF_CUTOFF_EG_AMT, 100)
