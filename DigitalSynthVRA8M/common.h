...
const uint8_t LFO_RATE          = 16;
const uint8_t VCO_MIX_EG_AMT    = 17;
const uint8_t VCO_COLOR_LFO_AMT = 18;
const uint8_t VCO_PITCH_LFO_AMT = 19;
const uint8_t VCF_CUTOFF_EG_AMT = 20;
const uint8_t EG_ATTACK         = 21;
const uint8_t EG_DECAY_RELEASE  = 22;
const uint8_t EG_SUSTAIN        = 23;
const uint8_t LFO_LEVEL_EG_COEF = 24;
const uint8_t VCO_MIX           = 25;
const uint8_t VCO_PULSE_WIDTH   = 26;
const uint8_t VCO_SAW_SHIFT     = 27;
const uint8_t VCF_CUTOFF        = 28;
const uint8_t VCF_RESONANCE     = 29;
const uint8_t VCA_GAIN          = 30;
const uint8_t PORTAMENTO        = 31;
