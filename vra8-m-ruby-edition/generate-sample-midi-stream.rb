...
def play_cdefgabc(c)
  ...
  play(21 + (c * 12), 1200)
  play(23 + (c * 12), 1200)
  play(24 + (c * 12), 4800 * 10)
  wait(4800)
end

control_change(ALL_NOTES_OFF,        0)
control_change(VCF_CUTOFF_FREQUENCY, 127)
control_change(VCF_RESONANCE,        127)
control_change(VCF_ENVELOPE_AMOUNT,  0)
control_change(EG_ATTACK_TIME,       127)
control_change(EG_DECAY_TIME,        127)
